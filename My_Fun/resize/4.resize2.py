...
def resize_and_augment(image_path, xml_folder, output_folder, max_size=640):
    ...
    try:
        ...
        # 更新XML文件并保存
        success = update_xml(tree, bbs_aug, (new_height, new_width), annotations_output_dir, xml_filename)
        return success
    except Exception:
...
if __name__ == "__main__":
    ...
    output_folder = r"E:\code\dataset\seat4\resized"
    max_size = 640  # 最大边长尺寸
